  ...
  const handleApproveWithSignature = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("❌ [MANAGER OPS] Approval failed:", data);
        alert(data.error || data.message || "Gagal menyetujui laporan");
      }
    } catch (error) {
      console.error("💥 [MANAGER OPS] Error approving inspeksi:", error);
      alert("Terjadi kesalahan saat menyetujui laporan: " + (error instanceof Error ? error.message : String(error)));
    } finally {
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full my-8">
            <div className="px-6 py-5 border-b border-gray-200 sticky top-0 bg-white z-10 rounded-t-2xl">
              <h3 className="text-xl font-bold text-gray-900">
                ✍️ Preview & Tanda Tangan Manager Operational
              </h3>
            ...
            <div className="max-h-[calc(90vh-200px)] overflow-y-auto">
              {loadingDetail ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-600 mt-4 font-semibold">Memuat detail laporan...</p>
                </div>
              ) : inspeksiDetail ? (
                <div className="p-6">
                  ...
                  {inspeksiDetail.ttdManagerTraffic && (
                    <div className="bg-green-50 border-2 border-green-500 rounded-xl p-5 mb-6">
                      <h5 className="font-bold text-green-700 mb-3 flex items-center gap-2">
                        <span className="text-xl">✅</span> Disetujui Manager Traffic
                      </h5>
                      <div className="flex items-start gap-4">
                        ...
                        <div className="border-2 border-green-400 rounded-lg p-3 bg-white shadow-sm">
                          ...
                          />
                          <p className="text-xs text-center text-gray-600 mt-2 font-medium">Tanda Tangan Manager Traffic</p>
                        </div>
                      </div>
                    </div>
                  )}

                  {/* Form Tanda Tangan Manager Operational */}
                  <div className="bg-blue-50 border-2 border-blue-500 rounded-xl p-6">
                    <h5 className="font-bold text-blue-700 mb-4 flex items-center gap-2">
                      <span className="text-xl">✍️</span> Tanda Tangan Manager Operational
                    </h5>
                    <div>
                ...
                <div className="text-center py-16">
                  <p className="text-gray-600 font-semibold">Gagal memuat detail laporan</p>
                </div>
              )}
            </div>
            ...
            <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 flex gap-3 justify-end sticky bottom-0 rounded-b-2xl">
              <button
                ...
                className="px-5 py-2.5 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition font-semibold shadow-sm"
                disabled={signing}
              >
                🗑️ Hapus TTD
              </button>
              ...
              <button
                ...
                className="px-5 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-semibold shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
